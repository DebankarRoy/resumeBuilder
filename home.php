						...
						<div class="modal-content">
							...
							<div class="modal-body">
									<div class="modal-conts">
										...
										<form role="form" novalidate="novalidate" id="graduation_details" name="graduation" enctype="multipart/form-data" method="POST" action = "education-submit.php">
												...
												<div class="row grad-stat">Graduation status*:
													<div class="row deg-container">
														<div class="deg degree_completion_status_container_pursuing">
															<input type="radio" id="degree_completion_status_pursuing" name="degree_completion_status_grad" value="pursuing" aria-required="true">Pursuing
														</div>
														<div class="deg degree_completion_status_container_completed">
													 		<input type="radio" id="degree_completion_status_completed" name="degree_completion_status_grad" value="completed">Completed
												 		</div>
											 		</div>
										 		</div>
						...
						<div class="modal-content">
							<div class="modal-body">
								<div class="modal-conts">
									...
									<div class="col padding"></div>
									<div class="col dataform">
										<div class="row hs-stat">Graduation status*:
												<div class="row deg-container">
													<div class="deg degree_completion_status_container_pursuing">
								 		...
								 		<div class="row schoolname">School*:
									 			<div class="name-container">
									 				<input type="text" id="school" tabindex="1" class="input-name" autocomplete="off" isautocomplete="" name="college" placeholder="Ex: Krishnath College School " required="" aria-required="true" aria-invalid="true">
									 			</div>
								 		</div>

								 		<div class="row course-completion">Year of Completion*:
									 				<div class="year-container">
									 					<select data-placeholder="Choose year..." id="start_year" name="start_year" class="chosen-select 
										...
										<div class="row boardname">Board*:
									 			<div class="name-container">
									 				<input type="text" id="board" tabindex="1" class="input-name" autocomplete="off" isautocomplete="" name="college" placeholder="Ex: WBBSE " required="" aria-required="true" aria-invalid="true">
									 			</div>
								 		</div>
								...
								<div class="secon-conts modal-conts">
									...
									<div class="col dataform">
										<div class="row secon-stat">Matriculation status*:
								 		...
								 		<div class="row schoolname">School*:
									 			<div class="name-container">
									 				<input type="text" id="school" tabindex="" class="input-name" autocomplete="off" isautocomplete="" name="School" placeholder="Ex: Krishnath College School " required="" aria-required="true" aria-invalid="true">
									 			</div>
								 		</div>
										...
										<div class="col dataform">
											<div class="row grad-stat">Post Graduation status*:
						 					...
						 					<div class="row degree-stream">
						 						<div class="col degree-name" id="input-type">Degree*:
						 							<div class="degree-name-container">
						 								<input type="text" id="degree" tabindex="4" class="deg-input" autocomplete="off" isautocomplete="" name="degree" placeholder="Ex: MBA " required="" aria-required="true" aria-invalid="true">
						 							</div>
						 						</div>
						 						<div class=" col stream-name" id="input-type">Stream:
						 							<div class="stream-container">
						 								<input type="text" id="stream" tabindex="5" class="stream-input" autocomplete="off" isautocomplete="" name="stream" placeholder="Ex: Finance ">
						 							</div>
						 						</div>
						 					</div>
						 					<div class="row tips_education">
									...
									<div class="modal-conts">
										...
										<div class="col dataform">
											<div class="row grad-stat">PhD status*:
									 		...
									 		<div class="row collegename">College*:
									 			<div class="name-container">
									 				<input type="text" id="college" tabindex="1" class="input-name" autocomplete="off" isautocomplete="" name="college" placeholder="Ex: IIT,KGP " required="" aria-required="true" aria-invalid="true">
									 			</div>
									 		</div>
									 		<div class="row course-duration">
									 			<div class="col start-year">Start year*:
						 					...
						 					<div class="row dip-degree-stream">
						 						<div class=" col dip-stream-name" id="input-type">Stream:
						 							<div class="stream-container">
						 								<input type="text" id="stream" tabindex="5" class="stream-input" autocomplete="off" isautocomplete="" name="stream" placeholder="Ex: Bussiness Studies ">
						 							</div>
						 						</div>
						 					</div>
